...
from ring_resonators.cavity_fit.cavity_metrics import calculate_enhancement, calculate_rates


DATA_DIR = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
            "/New_mounted_device/4K/03112025")
CSV_PATH = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
            "/New_mounted_device/4K/03112025/resonances_03_11_2025.csv")
OUTPUT_DIR = ("/Users/alexkolar/Desktop/Lab/lab-plotting/output_figs/ring_resonators"
              "/new_mounted/4K_cavity/4K_03112025/testing")

# parameters for the device (to use for power calculation)
n_eff = 2.18
L = np.pi * 220 * 1e-6  # unit: m
c = 3e8  # unit: m/s
gamma = 1.66e-5
...
for device in center_by_device:
    ...
    n_photons_1, n_photons_2 = calculate_rates(centers, qs, contrasts,
                                               L=L, n_eff=n_eff, gamma=gamma, power=1)
    ...
    plt.xlabel("Frequency (THz)")
    plt.ylabel(r"Pair rate (s$^{-1}$mW$^{-2}$)")
    plt.yscale('log')
