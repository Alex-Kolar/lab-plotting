...
FILENAME = ('/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators'
            '/Mounted_device_mk_3/4K/2025_07_24/pairs/pairs_5min_300mA.txt')
FITTING = False  # add a fit
WAVELENGTH = 1537.782  # units: nm
SAVE_FILE = True
OUTPUT_PATH = ("/Users/alexkolar/Desktop/Lab/lab-plotting/output_figs"
               "/ring_resonators/poster/coincidence_100ps_mod_fit.pdf")

# plotting params
mpl.rcParams.update({'font.sans-serif': 'Helvetica',
                     'font.size': 10})
xlim_range = 50  # size of x lims, in ns
color = 'coral'
...
if FITTING:
    ...
    print('k:', kappa)
    print('correlation:', 1/(np.pi*kappa))
