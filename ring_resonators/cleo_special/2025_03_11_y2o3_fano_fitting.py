...
DATA = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators/y2o3_data/2025_03_11_d11_full/CSVC.csv")
SCAN_START = 194851.421  # unit: GHz
SCAN_END = 194888.098  # unit: GHz
...
peaks, peak_res = find_peaks(-smoothed_data,
                             prominence=0.03, distance=10, width=10)
...
# # legend stuff (uncomment for actual plot)
# ax.set_ylim(-1, 0)
