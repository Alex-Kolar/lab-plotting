...
DATA_DIR = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
            "/New_mounted_device/10mK/PL_scan_2024_10_03")
OUTPUT_DIR = ("/Users/alexkolar/Desktop/Lab/lab-plotting/output_figs/ring_resonators"
              "/new_mounted/10mK_pl/all_fitted_decay/10032024")
CUTOFF_IDX = 5
...
for file in pl_files:
    ...
    freq_str = file_parts[-5] + '_' + file_parts[-4]
    frequency = file_parts[-5] + '.' + file_parts[-4]  # before and after decimal
