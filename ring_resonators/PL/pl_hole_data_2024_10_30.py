...
# NOTE: Magnet was quenched during this experiment


DATA_DIR = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
            "/New_mounted_device/10mK/PL_scan_2024_10_30")
POWER_DATA = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
              "/New_mounted_device/10mK/PL_scan_2024_10_30/power_monitor/power_monitor_2024-10-30_19-45-23.csv")
OUTPUT_DIR = ("/Users/alexkolar/Desktop/Lab/lab-plotting/output_figs/ring_resonators"
              "/new_mounted/10mK_pl/all_fitted_decay/10302024")
CUTOFF_IDX = 20
...
plt.errorbar(pump_times, area_fit, yerr=area_err,
             ls='', marker='o', capsize=3, color=color)
...
axs[1].plot(pump_times, laser_pulses,
            ls='', marker='o', color=color2)
axs[2].errorbar(pump_times, 1e3*tau, yerr=1e3*tau_err,
                ls='', marker='o', capsize=3, color=color3)
...
# plotting of power data
plt.plot(1e3*power_df['PD Voltage'],
         color=color2)

plt.xlabel("Index")
plt.ylabel("Photodiode Response (mV)")
plt.gcf().autofmt_xdate()
# plt.xlim((min(power_df['time']),
#           max(power_df['time'])))
