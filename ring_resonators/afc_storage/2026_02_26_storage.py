...
OFFRES_DATA = ('/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators'
               '/Mounted_device_mk_5/10mK/2026_02_26/afc/afc_offres_1min.npz')
STORAGE_DATA = ('/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators'
                '/Mounted_device_mk_5/10mK/2026_02_26/afc/afc_storage_60nspulse_1us.npz')
...
plt.bar(time, data_offres['counts']*5,  # only integrated for 1 minute
        width=time_diff,
...
counts_in = np.sum(data_offres['counts'][idx_in]) * 5  # only integrated for 1 minute
