...
DATA_DIR = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
            "/Bulk_crystal/10mK/01032025/AMP")
...
BG_DATA = ("/Users/alexkolar/Library/CloudStorage/Box-Box/Zhonglab/Lab data/Ring Resonators"
           "/Bulk_crystal/10mK/01032025/AMP/OFFRES.csv")
...
ax.set_title(rf"$N$ = {N}, $\Delta$ = {Delta} MHz, $F$ = {F:0.3f}, Burn Time = 5 minutes")
...
# long burn time
idx_to_plot = np.where(burn_times == int(5))[0]
